...
import * as META from '@app/server/common/constants/meta.constant'
import * as TEXT from '@app/server/common/constants/text.constant'
...
const buildHttpDecorator = (
  ...
  const { errMessage, successMessage, errCode, successCode, usePaginate } =
    options
